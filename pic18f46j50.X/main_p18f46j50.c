...
#define _XTAL_FREQ 4000000  // Frecuencia del PIC
...
void main(void) {
    ...
    while(1) {
        LATD = 0b00000001; __delay_ms(500);
        LATD = 0b00000010; __delay_ms(500);
        LATD = 0b00000100; __delay_ms(500);
        LATD = 0b00001000; __delay_ms(500);
    }
}