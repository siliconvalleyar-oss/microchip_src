...
//----------------------------------------
// FUNCIONES DE TEXTO INVERTIDO
//----------------------------------------
void OLED_PrintCharInverted(char c)
{
    uint8_t index;
    ...
    OLED_WriteData(0xFF);  // Espacio invertido entre caracteres
}

void OLED_PrintStringInverted(const char* str)
{
    while(*str)
    {
        OLED_PrintCharInverted(*str++);
    }
}

void OLED_ClearLine(uint8_t line)
{
    OLED_SetCursor(0, line);
