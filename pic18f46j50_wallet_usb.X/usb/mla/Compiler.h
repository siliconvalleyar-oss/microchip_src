...
#if defined(__18CXX) && !defined(HI_TECH_C) && !defined(__XC8)	
	// PIC18 processor with Microchip C18 compiler
    #define COMPILER_MPLAB_C18
    #include <p18cxxx.h>
#elif defined(__XC8)
	// PIC18 processor with Microchip XC8 compiler
    #define COMPILER_MPLAB_C18
    #ifndef __18CXX
        #define __18CXX
    #endif
...
// (PIC10, PIC12, PIC16, PIC18)
	...
	// Microchip C18 specific defines (not for XC8)
	#if defined(COMPILER_MPLAB_C18) && !defined(__XC8)
	    #define ROM                 	rom
	#endif
	
	// HI TECH and XC8 specific defines
	#if defined(COMPILER_HITECH_PICC18) || defined(COMPILER_HITECH_PICC) || defined(__XC8)
	    #define ROM                 	const
		#define rom
        #ifndef Nop()
        #define Nop()               	asm("NOP");
        ...
        #endif
        #if defined(__XC8)
            #define FAR             	// XC8 does not support the 'far' keyword
        #endif
	#endif
