...
//////////////////////////////////////////////////////////////////////////////
//fonts.cpp
#include <stdint.h>   // XC32: usar stdint.h en lugar de cstdint
#include "fonts.h"
//#include <string.h>
...
const  unsigned  char Font_Three[] = {
	0x00,0x00,0x00,0x00, //  
	0x00,0x36,0x00,0x00, // !
	0x00,0x06,0x00,0x06, // "
	0x36,0x49,0x49,0x36, // #
...
// 32 height 16 width
const uint8_t Font_Seven [11][64] = 
{
...
const  uint8_t Font_Eight[11][32] = 
{
...
// Opción 1: Usar reinterpret_cast (más seguro para este uso)
const uint8_t* pFontBigNumptr = reinterpret_cast<const uint8_t*>(Font_Seven);
const uint8_t* pFontMedNumptr = reinterpret_cast<const uint8_t*>(Font_Eight);
