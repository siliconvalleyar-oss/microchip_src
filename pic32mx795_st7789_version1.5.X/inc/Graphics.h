...
namespace Graphics {
    ...
    // ---- Sprites de juego ----
    // dir: 0=arriba 1=abajo 2=izq 3=der
    void draw_pacman(int16_t x, int16_t y, bool mouth_open, uint8_t dir);
    // escala 1=normal(18px), 3=pantalla titulo(54px)
    ...
    // ---- Laberinto ----
    void draw_dot  (int16_t cellPx, int16_t cellPy);          // posición px de celda
    void draw_power(int16_t cellPx, int16_t cellPy);          // punto grande
    void draw_wall_cell(int16_t px, int16_t py,
                        bool top, bool bot, bool lft, bool rgt); // celda de pared
